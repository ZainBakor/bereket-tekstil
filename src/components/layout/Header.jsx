            ...
            <div className="header-top">
                <div className="container flex justify-between items-center">
                    <div className="header-top-left flex gap-lg">
                        <a href="tel:+905551234567" className="header-contact">
                    ...
                    <div className="header-top-right flex gap-md">
                        ...
                        <a href="https://wa.me/905551234567" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="WhatsApp">
